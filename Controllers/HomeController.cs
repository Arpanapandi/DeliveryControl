...
public class HomeController : Controller
{
    ...
    private async Task AutoGenerateSchedulesForTodayIfNeeded(DateTime targetDate)
    {
        ...
        // Jika sudah pernah auto-generate untuk hari ini, jangan ulangi
        var alreadyAutoGenerated = await _context.DeliverySchedules
            .AsNoTracking()
            .AnyAsync(s => s.ScheduledDate.Date == targetDate.Date && s.CreatedBy == "AutoScheduler");
