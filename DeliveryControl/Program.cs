...
builder.Services.AddHostedService<DeliveryControl.Services.StockSnapshotService>();
builder.Services.AddSingleton<DeliveryControl.Services.StockSnapshotService>();
