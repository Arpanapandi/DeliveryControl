...
namespace DeliveryControl.Controllers
{
    public class StockController : Controller
    {
        ...
        // ─────────────────────────────────────────────────────────────────
        //  TREND CRITICAL STOCK — grafik garis <1D & <1.5D per plant
        // ─────────────────────────────────────────────────────────────────

        public async Task<IActionResult> TrendCriticalStock(
            string level  = "1.5D",
            string period = "30d")
        {
            ...
            ViewBag.DateLabels     = JsonSerializer.Serialize(
                                        dateRange.Select(d => d.ToString("dd/MM")).ToList());
