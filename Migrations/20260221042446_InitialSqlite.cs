        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldData = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    NewData = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AutoCode = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ...
                    Cycle = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    Docking = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Pickup = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ETD = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Range = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    SKID = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    Area = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    StdPrepareTime = table.Column<int>(type: "INTEGER", nullable: false),
                    StartPrepareTime = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerPartNumber = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rack = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    NoRack = table.Column<int>(type: "INTEGER", nullable: true),
                    Customer = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    VIN = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    QtyLot = table.Column<int>(type: "INTEGER", nullable: true),
                    RackMin = table.Column<int>(type: "INTEGER", nullable: true),
                    ROP = table.Column<int>(type: "INTEGER", nullable: true),
                    RackMax = table.Column<int>(type: "INTEGER", nullable: true),
                    CustomerPartNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    KanbanType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScheduleId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ScheduleNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    CustomerId = table.Column<int>(type: "INTEGER", nullable: false),
                    Route = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Cycle = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    EnterDockTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PickupTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ETD = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Range = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    SKID = table.Column<string>(type: "TEXT", nullable: true),
                    Area = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    ActualEnterDockTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ActualStartTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ActualEndTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ReadyToDockTime = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ActPrepareTime = table.Column<double>(type: "REAL", nullable: true),
                    StartPrepareTime = table.Column<int>(type: "INTEGER", nullable: false),
                    StdPrepareTime = table.Column<int>(type: "INTEGER", nullable: false),
                    PreparationStatus = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    DriverStatus = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PullingId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Area", "AutoCode", "CreatedDate", "CustomerCode", "CustomerName", "Cycle", "Docking", "ETD", "IsActive", "Pickup", "Range", "Route", "SKID", "StartPrepareTime", "StdPrepareTime", "UpdatedDate" },
                values: new object[,]
                {
                    { 1, null, null, new DateTime(2026, 2, 21, 11, 24, 44, 729, DateTimeKind.Local).AddTicks(327), "CUST001", "PT ABC Manufacturing", null, null, null, true, null, null, "Route A", "10 SKID", 0, 0, null },
                    { 2, null, null, new DateTime(2026, 2, 21, 11, 24, 44, 729, DateTimeKind.Local).AddTicks(330), "CUST002", "PT XYZ Industries", null, null, null, true, null, null, "Route B", "15 SKID", 0, 0, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Raw Material", new DateTime(2026, 2, 21, 11, 24, 44, 729, DateTimeKind.Local).AddTicks(662), null, null, "Raw material untuk produksi", true, "ITM001", "Raw Material A", null, 20, 5, null, null, null, null, null, null, null, "KG", null, null, null, 1.0m },
                    { 2, "Finished Goods", new DateTime(2026, 2, 21, 11, 24, 44, 729, DateTimeKind.Local).AddTicks(666), null, null, "Produk jadi siap kirim", true, "ITM002", "Finished Product B", null, 20, 5, null, null, null, null, null, null, null, "PCS", null, null, null, 2.5m },
                    { 3, "Packaging", new DateTime(2026, 2, 21, 11, 24, 44, 729, DateTimeKind.Local).AddTicks(669), null, null, "Material packaging", true, "ITM003", "Packaging Material", null, 20, 5, null, null, null, null, null, null, null, "BOX", null, null, null, 0.5m }
                });
