    ...
    public partial class InitialSqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScheduleId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ScheduleNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    CustomerId = table.Column<int>(type: "INTEGER", nullable: false),
                    Route = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Cycle = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    ...
                    Range = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    SKID = table.Column<int>(type: "INTEGER", nullable: true),
                    Area = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PoolingId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Plant = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2026, 1, 27, 8, 26, 14, 933, DateTimeKind.Local).AddTicks(3823), "CUST001", "PT ABC Manufacturing", null, null, null, true, null, null, "Route A", "10 SKID", null },
                    { 2, null, new DateTime(2026, 1, 27, 8, 26, 14, 933, DateTimeKind.Local).AddTicks(3826), "CUST002", "PT XYZ Industries", null, null, null, true, null, null, "Route B", "15 SKID", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Raw Material", new DateTime(2026, 1, 27, 8, 26, 14, 933, DateTimeKind.Local).AddTicks(3942), "Raw material untuk produksi", true, "ITM001", "Raw Material A", "KG", null, null, 1.0m },
                    { 2, "Finished Goods", new DateTime(2026, 1, 27, 8, 26, 14, 933, DateTimeKind.Local).AddTicks(3945), "Produk jadi siap kirim", true, "ITM002", "Finished Product B", "PCS", null, null, 2.5m },
                    { 3, "Packaging", new DateTime(2026, 1, 27, 8, 26, 14, 933, DateTimeKind.Local).AddTicks(3948), "Material packaging", true, "ITM003", "Packaging Material", "BOX", null, null, 0.5m }
                });
